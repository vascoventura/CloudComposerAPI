 ...
 */
@Schema(description = "The provider  *New in version 2.1.0* ")
...
public class Provider {
   ...
   * @return packageName
  **/
  @Schema(description = "The package name of the provider.")
   ...
   * @return description
  **/
  @Schema(description = "The description of the provider.")
   ...
   * @return version
  **/
  @Schema(description = "The version of the provider.")
