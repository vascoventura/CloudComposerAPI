 ...
 */
@Schema(description = "Log of user operations via CLI or Web UI.")
...
public class EventLog {
  ...
  private Integer eventLogId = null;
   ...
   * @return eventLogId
  **/
  @Schema(description = "The event log ID")
   ...
   * @return when
  **/
  @Schema(description = "The time when these events happened.")
  ...
  **/
   ...
   * @return event
  **/
  @Schema(description = "A key describing the type of event.")
  ...
  **/
  @Schema(description = "When the event was dispatched for an object having execution_date, the value of this field. ")
   ...
   * @return owner
  **/
  @Schema(description = "Name of the user who triggered these events a.")
   ...
   * @return extra
  **/
  @Schema(description = "Other information that was not included in the other fields, e.g. the complete CLI command. ")
