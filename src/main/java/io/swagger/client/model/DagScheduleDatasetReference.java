 ...
 */
@Schema(description = "A datasets reference to a downstream DAG.  *New in version 2.4.0* ")
...
public class DagScheduleDatasetReference {
   ...
   * @return dagId
  **/
  @Schema(description = "The DAG ID that depends on the dataset.")
   ...
   * @return createdAt
  **/
  @Schema(description = "The dataset reference creation time")
   ...
   * @return updatedAt
  **/
  @Schema(description = "The dataset reference update time")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.dagId, dagScheduleDatasetReference.dagId) &&
        Objects.equals(this.createdAt, dagScheduleDatasetReference.createdAt) &&
        Objects.equals(this.updatedAt, dagScheduleDatasetReference.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dagId, createdAt, updatedAt);
  }
