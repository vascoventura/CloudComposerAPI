...
import io.swagger.client.model.BasicDAGRun;
 ...
 */
@Schema(description = "A dataset event.  *New in version 2.4.0* ")
...
public class DatasetEvent {
  ...
  @SerializedName("dataset_uri")
  private String datasetUri = null;

  @SerializedName("extra")
  private Object extra = null;

  @SerializedName("source_dag_id")
  private String sourceDagId = null;
  ...
  @SerializedName("source_map_index")
  private Integer sourceMapIndex = null;

  @SerializedName("created_dagruns")
  private List<BasicDAGRun> createdDagruns = null;
  ...
  **/
   ...
   * @return datasetUri
  **/
  @Schema(description = "The URI of the dataset")
   ...
   * @return extra
  **/
  @Schema(description = "The dataset event extra")
   ...
   * @return sourceDagId
  **/
  @Schema(description = "The DAG ID that updated the dataset.")
   ...
   * @return sourceTaskId
  **/
  @Schema(description = "The task ID that updated the dataset.")
   ...
   * @return sourceRunId
  **/
  @Schema(description = "The DAG run ID that updated the dataset.")
  ...
  **/
  @Schema(description = "The task map index that updated the dataset.")
  ...
  public DatasetEvent addCreatedDagrunsItem(BasicDAGRun createdDagrunsItem) {
    if (this.createdDagruns == null) {
      this.createdDagruns = new ArrayList<BasicDAGRun>();
    }
  ...
  **/
   ...
   * @return timestamp
  **/
  @Schema(description = "The dataset event creation time")
