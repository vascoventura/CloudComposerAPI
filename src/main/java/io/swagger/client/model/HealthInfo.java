...
import io.swagger.client.model.MetadatabaseStatus;
import io.swagger.client.model.SchedulerStatus;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * Instance status information.
 */
@Schema(description = "Instance status information.")
...
public class HealthInfo {
  @SerializedName("metadatabase")
  private MetadatabaseStatus metadatabase = null;

  @SerializedName("scheduler")
  private SchedulerStatus scheduler = null;
