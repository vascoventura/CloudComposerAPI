 ...
 */
@Schema(description = "XCom entry collection item. The value field are only available when retrieving a single object due to the sensitivity of this data.")
...
public class VariableCollectionItem {
  ...
  **/
   ...
   * @return description
  **/
  @Schema(description = "The description of the variable.  *New in version 2.4.0* ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.key, variableCollectionItem.key) &&
        Objects.equals(this.description, variableCollectionItem.description);
  }
