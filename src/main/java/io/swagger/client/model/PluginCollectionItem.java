 ...
 */
@Schema(description = "A plugin Item.  *New in version 2.1.0* ")
...
public class PluginCollectionItem {
  ...
  @SerializedName("flask_blueprints")
  private List<Object> flaskBlueprints = null;

  @SerializedName("appbuilder_views")
  private List<Object> appbuilderViews = null;

  @SerializedName("appbuilder_menu_items")
  private List<Object> appbuilderMenuItems = null;

  @SerializedName("global_operator_extra_links")
  private List<Object> globalOperatorExtraLinks = null;

  @SerializedName("operator_extra_links")
  ...
  **/
   ...
   * @return hooks
  **/
  @Schema(description = "The plugin hooks")
   ...
   * @return executors
  **/
  @Schema(description = "The plugin executors")
   ...
   * @return macros
  **/
  @Schema(description = "The plugin macros")
  ...
  **/
  @Schema(description = "The flask blueprints")
  ...
  **/
  @Schema(description = "The appuilder views")
  ...
  **/
  @Schema(description = "The Flask Appbuilder menu items")
  ...
  **/
  @Schema(description = "The global operator extra links")
  ...
  **/
  @Schema(description = "Operator extra links")
   ...
   * @return source
  **/
  @Schema(description = "The plugin source")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, hooks, executors, macros, flaskBlueprints, appbuilderViews, appbuilderMenuItems, globalOperatorExtraLinks, operatorExtraLinks, source);
  }
