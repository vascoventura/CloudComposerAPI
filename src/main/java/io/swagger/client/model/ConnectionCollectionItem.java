 ...
 */
@Schema(description = "Connection collection item. The password and extra fields are only available when retrieving a single object due to the sensitivity of this data. ")
...
public class ConnectionCollectionItem {
  ...
  **/
   ...
   * @return connType
  **/
  @Schema(description = "The connection type.")
   ...
   * @return description
  **/
  @Schema(description = "The description of the connection.")
   ...
   * @return host
  **/
  @Schema(description = "Host of the connection.")
   ...
   * @return login
  **/
  @Schema(description = "Login of the connection.")
   ...
   * @return schema
  **/
  @Schema(description = "Schema of the connection.")
   ...
   * @return port
  **/
  @Schema(description = "Port of the connection.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connectionId, connType, description, host, login, schema, port);
  }
