...
import io.swagger.client.model.UserCollectionItemRoles;
 ...
 */
@Schema(description = "A user object.  *New in version 2.1.0* ")
...
public class UserCollectionItem {
   ...
   * @return firstName
  **/
  @Schema(description = "The user's first name.  *Changed in version 2.4.0*&#58; The requirement for this to be non-empty was removed. ")
   ...
   * @return lastName
  **/
  @Schema(description = "The user's last name.  *Changed in version 2.4.0*&#58; The requirement for this to be non-empty was removed. ")
   ...
   * @return username
  **/
  @Schema(description = "The username.  *Changed in version 2.2.0*&#58; A minimum character length requirement ('minLength') is added. ")
   ...
   * @return email
  **/
  @Schema(description = "The user's email.  *Changed in version 2.2.0*&#58; A minimum character length requirement ('minLength') is added. ")
  ...
  **/
   ...
   * @return lastLogin
  **/
  @Schema(description = "The last user login")
   ...
   * @return loginCount
  **/
  @Schema(description = "The login count")
  ...
  **/
  @Schema(description = "The number of times the login failed")
  ...
  public UserCollectionItem addRolesItem(UserCollectionItemRoles rolesItem) {
    if (this.roles == null) {
      this.roles = new ArrayList<UserCollectionItemRoles>();
    }
   ...
   * @return roles
  **/
  @Schema(description = "User roles.  *Changed in version 2.2.0*&#58; Field is no longer read-only. ")
  ...
  **/
   ...
   * @return changedOn
  **/
  @Schema(description = "The date user was changed")
