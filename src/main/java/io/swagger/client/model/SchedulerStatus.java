 ...
 */
@Schema(description = "The status and the latest scheduler heartbeat.")
...
public class SchedulerStatus {
  ...
  @SerializedName("latest_scheduler_heartbeat")
  private String latestSchedulerHeartbeat = null;
  ...
  **/
  @Schema(description = "The time the scheduler last do a heartbeat.")
