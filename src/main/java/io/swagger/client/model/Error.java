 ...
 */
@Schema(description = "[RFC7807](https://tools.ietf.org/html/rfc7807) compliant response. ")
...
public class Error {
   ...
   * @return type
  **/
  @Schema(required = true, description = "A URI reference [RFC3986] that identifies the problem type. This specification encourages that, when dereferenced, it provide human-readable documentation for the problem type. ")
   ...
   * @return title
  **/
  @Schema(required = true, description = "A short, human-readable summary of the problem type.")
   ...
   * @return status
  **/
  @Schema(required = true, description = "The HTTP status code generated by the API server for this occurrence of the problem.")
