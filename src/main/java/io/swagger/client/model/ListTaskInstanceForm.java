...
public class ListTaskInstanceForm {
  ...
  @SerializedName("duration_gte")
  private BigDecimal durationGte = null;

  @SerializedName("duration_lte")
  private BigDecimal durationLte = null;
  ...
  **/
  @Schema(description = "Returns objects greater or equal to the specified date.  This can be combined with execution_date_lte parameter to receive only the selected period. ")
  ...
  **/
  @Schema(description = "Returns objects less than or equal to the specified date.  This can be combined with execution_date_gte parameter to receive only the selected period. ")
   ...
   * @return startDateGte
  **/
  @Schema(description = "Returns objects greater or equal the specified date.  This can be combined with start_date_lte parameter to receive only the selected period. ")
  ...
  **/
   ...
   * @return endDateLte
  **/
  @Schema(description = "Returns objects less than or equal to the specified date.  This can be combined with start_date_gte parameter to receive only the selected period. ")
   ...
   * @return durationGte
  **/
  @Schema(description = "Returns objects greater than or equal to the specified values.  This can be combined with duration_lte parameter to receive only the selected period. ")
   ...
   * @return durationLte
  **/
  @Schema(description = "Returns objects less than or equal to the specified values.  This can be combined with duration_gte parameter to receive only the selected range. ")
  ...
  public ListTaskInstanceForm addStateItem(TaskState stateItem) {
    if (this.state == null) {
      this.state = new ArrayList<TaskState>();
    }
   ...
   * @return state
  **/
  @Schema(description = "The value can be repeated to retrieve multiple matching values (OR condition).")
