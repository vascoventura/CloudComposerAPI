 ...
 */
@Schema(description = "A datasets reference to an upstream task.  *New in version 2.4.0* ")
...
public class TaskOutletDatasetReference {
   ...
   * @return dagId
  **/
  @Schema(description = "The DAG ID that updates the dataset.")
   ...
   * @return taskId
  **/
  @Schema(description = "The task ID that updates the dataset.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.dagId, taskOutletDatasetReference.dagId) &&
        Objects.equals(this.taskId, taskOutletDatasetReference.taskId) &&
        Objects.equals(this.createdAt, taskOutletDatasetReference.createdAt) &&
        Objects.equals(this.updatedAt, taskOutletDatasetReference.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dagId, taskId, createdAt, updatedAt);
  }
