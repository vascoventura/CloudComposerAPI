...
import io.swagger.client.model.DagState;
...
public class DAGRun {
  ...
  private OffsetDateTime logicalDate = null;
  ...
  private OffsetDateTime dataIntervalStart = null;

  @SerializedName("data_interval_end")
  private OffsetDateTime dataIntervalEnd = null;

  @SerializedName("last_scheduling_decision")
  private OffsetDateTime lastSchedulingDecision = null;
  ...
  public enum RunTypeEnum {
    ...
    public static RunTypeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<RunTypeEnum> {
      ...
      public RunTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return RunTypeEnum.fromValue((String)(value));
      }
    }
  }  @SerializedName("run_type")
  private RunTypeEnum runType = null;

  @SerializedName("state")
  private DagState state = null;
   ...
   * @return dagRunId
  **/
  @Schema(description = "Run ID.  The value of this field can be set only when creating the object. If you try to modify the field of an existing object, the request fails with an BAD_REQUEST error.  If not provided, a value will be generated based on execution_date.  If the specified dag_run_id is in use, the creation request fails with an ALREADY_EXISTS error.  This together with DAG_ID are a unique key. ")
  ...
  **/
  @Schema(description = "The execution date. This is the same as logical_date, kept for backwards compatibility. If both this field and logical_date are provided but with different values, the request will fail with an BAD_REQUEST error.  *Changed in version 2.2.0*&#58; Field becomes nullable.  *Deprecated since version 2.2.0*&#58; Use 'logical_date' instead. ")
   ...
   * @return startDate
  **/
  @Schema(description = "The start time. The time when DAG run was actually created.  *Changed in version 2.1.3*&#58; Field becomes nullable. ")
  ...
  **/
  @Schema(description = "")
  public OffsetDateTime getDataIntervalStart() {
    return dataIntervalStart;
  }
  ...
  **/
  @Schema(description = "")
  public OffsetDateTime getDataIntervalEnd() {
    return dataIntervalEnd;
  }
  ...
  **/
  @Schema(description = "")
  public OffsetDateTime getLastSchedulingDecision() {
    return lastSchedulingDecision;
  }
  ...
  **/
   ...
   * @return conf
  **/
  @Schema(description = "JSON object describing additional configuration parameters.  The value of this field can be set only when creating the object. If you try to modify the field of an existing object, the request fails with an BAD_REQUEST error. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.dagRunId, daGRun.dagRunId) &&
        ...
        Objects.equals(this.dataIntervalStart, daGRun.dataIntervalStart) &&
        Objects.equals(this.dataIntervalEnd, daGRun.dataIntervalEnd) &&
        Objects.equals(this.lastSchedulingDecision, daGRun.lastSchedulingDecision) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dagRunId, dagId, logicalDate, executionDate, startDate, endDate, dataIntervalStart, dataIntervalEnd, lastSchedulingDecision, runType, state, externalTrigger, conf);
  }
