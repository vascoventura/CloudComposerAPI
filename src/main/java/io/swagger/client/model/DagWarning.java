...
public class DagWarning {
  ...
  **/
   ...
   * @return warningType
  **/
  @Schema(description = "The warning type for the dag warning.")
   ...
   * @return message
  **/
  @Schema(description = "The message for the dag warning.")
   ...
   * @return timestamp
  **/
  @Schema(description = "The time when this warning was logged.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dagId, warningType, message, timestamp);
  }
