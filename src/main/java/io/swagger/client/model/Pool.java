...
public class Pool {
  ...
  private Integer occupiedSlots = null;

  @SerializedName("used_slots")
  private Integer usedSlots = null;

  @SerializedName("queued_slots")
  private Integer queuedSlots = null;

  @SerializedName("open_slots")
  private Integer openSlots = null;
   ...
   * @return name
  **/
  @Schema(description = "The name of pool.")
   ...
   * @return slots
  **/
  @Schema(description = "The maximum number of slots that can be assigned to tasks. One job may occupy one or more slots. ")
  ...
  **/
  @Schema(description = "The number of slots used by running/queued tasks at the moment.")
   ...
   * @return usedSlots
  **/
  @Schema(description = "The number of slots used by running tasks at the moment.")
   ...
   * @return queuedSlots
  **/
  @Schema(description = "The number of slots used by queued tasks at the moment.")
   ...
   * @return openSlots
  **/
  @Schema(description = "The number of free slots at the moment.")
   ...
   * @return description
  **/
  @Schema(description = "The description of the pool.  *New in version 2.3.0* ")
