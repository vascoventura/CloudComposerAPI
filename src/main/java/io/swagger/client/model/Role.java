 ...
 */
@Schema(description = "a role item.  *New in version 2.1.0* ")
...
public class Role {
   ...
   * @return name
  **/
  @Schema(description = "The name of the role  *Changed in version 2.3.0*&#58; A minimum character length requirement ('minLength') is added. ")
