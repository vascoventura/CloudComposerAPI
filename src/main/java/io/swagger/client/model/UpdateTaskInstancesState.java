...
public class UpdateTaskInstancesState {
  ...
  private Boolean includeUpstream = null;

  @SerializedName("include_downstream")
  private Boolean includeDownstream = null;

  @SerializedName("include_future")
  private Boolean includeFuture = null;

  @SerializedName("include_past")
  private Boolean includePast = null;
  ...
  public enum NewStateEnum {
    ...
    public static class Adapter extends TypeAdapter<NewStateEnum> {
      ...
      public NewStateEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return NewStateEnum.fromValue((String)(value));
      }
    }
   ...
   * @return dryRun
  **/
  @Schema(description = "If set, don't actually run this operation. The response will contain a list of task instances planned to be affected, but won't be modified in any way. ")
  ...
  **/
  @Schema(description = "The execution date. Either set this or dag_run_id but not both.")
   ...
   * @return dagRunId
  **/
  @Schema(description = "The task instance's DAG run ID. Either set this or execution_date but not both.  *New in version 2.3.0* ")
  ...
  **/
   ...
   * @return newState
  **/
  @Schema(description = "Expected new state.")
