...
public class ImportError {
  @SerializedName("import_error_id")
  private Integer importErrorId = null;
  ...
  **/
  @Schema(description = "The import error ID.")
   ...
   * @return timestamp
  **/
  @Schema(description = "The time when this error was created.")
  ...
  **/
   ...
   * @return stackTrace
  **/
  @Schema(description = "The full stackstrace..")
