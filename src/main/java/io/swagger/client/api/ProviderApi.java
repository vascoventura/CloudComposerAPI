...
public class ProviderApi {
     ...
     */
    public InlineResponse200 getProviders() throws ApiException {
        ApiResponse<InlineResponse200> resp = getProvidersWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse200> getProvidersWithHttpInfo() throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getProvidersAsync(final ApiCallback<InlineResponse200> callback) throws ApiException {
