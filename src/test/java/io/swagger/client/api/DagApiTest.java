...
public class DagApiTest {
     ...
     */
    @Test
    public void deleteDagTest() throws Exception {
        String dagId = null;
        api.deleteDag(dagId);
     ...
     */
    @Test
    public void getDagTest() throws Exception {
        String dagId = null;
     ...
     */
    @Test
    public void getDagDetailsTest() throws Exception {
        String dagId = null;
     ...
     */
    @Test
    public void getDagSourceTest() throws Exception {
        String fileToken = null;
        InlineResponse2002 response = api.getDagSource(fileToken);
     ...
     */
    @Test
    public void getDagsTest() throws Exception {
        Integer limit = null;
        Integer offset = null;
        String orderBy = null;
     ...
     */
    @Test
    public void patchDagTest() throws Exception {
        DAG body = null;
        String dagId = null;
        List<String> updateMask = null;
        DAG response = api.patchDag(body, dagId, updateMask);
     ...
     */
    @Test
    public void patchDagsTest() throws Exception {
        DAG body = null;
        String dagIdPattern = null;
        Integer limit = null;
        Integer offset = null;
        ...
        List<String> updateMask = null;
        Boolean onlyActive = null;
        DAGCollection response = api.patchDags(body, dagIdPattern, limit, offset, tags, updateMask, onlyActive);
     ...
     */
    @Test
    public void postClearTaskInstancesTest() throws Exception {
        ClearTaskInstances body = null;
        String dagId = null;
        TaskInstanceReferenceCollection response = api.postClearTaskInstances(body, dagId);
     ...
     */
    @Test
    public void postSetTaskInstancesStateTest() throws Exception {
        UpdateTaskInstancesState body = null;
        String dagId = null;
        TaskInstanceReferenceCollection response = api.postSetTaskInstancesState(body, dagId);
