...
public class PoolApiTest {
     ...
     */
    @Test
    public void patchPoolTest() throws Exception {
        Pool body = null;
        String poolName = null;
        List<String> updateMask = null;
        Pool response = api.patchPool(body, poolName, updateMask);
     ...
     */
    @Test
    public void postPoolTest() throws Exception {
        Pool body = null;
        Pool response = api.postPool(body);
