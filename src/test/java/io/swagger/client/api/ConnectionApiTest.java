...
public class ConnectionApiTest {
     ...
     */
    @Test
    public void patchConnectionTest() throws Exception {
        Connection body = null;
        String connectionId = null;
        List<String> updateMask = null;
        Connection response = api.patchConnection(body, connectionId, updateMask);
    ...
    public void testConnectionTest() throws Exception {
        Connection body = null;
        ConnectionTest response = api.testConnection(body);
