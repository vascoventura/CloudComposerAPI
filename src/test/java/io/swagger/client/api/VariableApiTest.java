...
import io.swagger.client.model.VariableCollection;
...
public class VariableApiTest {
     ...
     */
    @Test
    public void getVariableTest() throws Exception {
        String variableKey = null;
     ...
     */
    @Test
    public void patchVariableTest() throws Exception {
        Variable body = null;
        String variableKey = null;
        List<String> updateMask = null;
        Variable response = api.patchVariable(body, variableKey, updateMask);
     ...
     */
    @Test
    public void postVariablesTest() throws Exception {
        Variable body = null;
        Variable response = api.postVariables(body);
