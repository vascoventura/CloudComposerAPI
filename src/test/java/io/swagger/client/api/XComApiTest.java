...
public class XComApiTest {
     ...
     */
    @Test
    public void getXcomEntriesTest() throws Exception {
        String dagId = null;
     ...
     */
    @Test
    public void getXcomEntryTest() throws Exception {
        String dagId = null;
        String dagRunId = null;
        String taskId = null;
        String xcomKey = null;
        Boolean deserialize = null;
        XCom response = api.getXcomEntry(dagId, dagRunId, taskId, xcomKey, deserialize);
